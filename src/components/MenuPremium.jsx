  ...
  return (
    <section id="menu" className="py-24 sm:py-32 bg-[#040504] relative">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex items-center gap-3 mb-4 text-[#EFC524]">
            <span className="h-[1px] w-12 bg-[#EFC524]/50"></span>
            <Beef className="w-5 h-5" />
            <span className="uppercase tracking-[0.3em] font-bold text-sm font-['Copperplate_Gothic_Bold',_'Cinzel',_serif]">Cortes Magistrales</span>
            <span className="h-[1px] w-12 bg-[#EFC524]/50"></span>
          </div>
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-white tracking-tight leading-none mb-6 font-['Copperplate_Gothic_Bold',_'Cinzel',_serif] uppercase">
            Menú de Autor
          </h2>
          <p className="max-w-2xl text-[#DE9983]/80 text-base sm:text-xl font-light font-['Crimson_Text',_serif]">
          ...
          {menuItems.map((item, index) => (
            ...
            >
              <motion.div
                ...
                className="h-full rounded-2xl sm:rounded-3xl overflow-hidden bg-[#393938]/20 backdrop-blur-md border border-[#393938]/50 hover:border-[#EFC524] hover:shadow-[0_0_30px_rgba(239,197,36,0.15)] transition-all duration-300 flex flex-col"
              >
                <div className="h-64 sm:h-72 w-full relative overflow-hidden">
                  <img 
                    ...
                    width="800"
                    height="600"
                    className="w-full h-full object-cover object-center group-hover:scale-105 group-hover:rotate-1 transition-transform duration-700 ease-out grayscale-[20%]"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#040504]/90 via-[#040504]/20 to-transparent"></div>
                  
                  {item.popular && (
                    <div className="absolute top-4 left-4 bg-[#EFC524] text-[#040504] font-bold py-1.5 px-4 rounded-full text-xs uppercase tracking-wider flex items-center gap-1 shadow-[0_0_15px_rgba(239,197,36,0.5)] font-['Copperplate_Gothic_Bold',_'Cinzel',_serif]">
                      <Flame className="w-4 h-4" /> Favorito
                    </div>
                  )}
                  
                  <div className="absolute top-4 right-4 bg-[#040504]/80 backdrop-blur-lg border border-[#EFC524]/30 text-white font-bold py-1.5 px-4 rounded-full shadow-lg text-lg group-hover:border-[#EFC524] transition-colors font-['Copperplate_Gothic_Bold',_'Cinzel',_serif]">
                    {item.price}
                  </div>
                </div>
                ...
                <div className="p-6 sm:p-8 flex-grow flex flex-col justify-between relative">
                  ...
                  <div className="relative z-10">
                    <h3 className="text-2xl sm:text-3xl font-bold text-white mb-4 group-hover:text-[#EFC524] transition-colors flex items-center justify-between font-['Copperplate_Gothic_Bold',_'Cinzel',_serif]">
                      {item.name}
                      <BadgeCheck className="w-6 h-6 text-zinc-600 group-hover:text-[#EFC524] transition-colors opacity-0 group-hover:opacity-100" />
                    </h3>
                    <div className="h-[1px] w-12 bg-white/10 mb-5 group-hover:w-full group-hover:bg-[#EFC524]/50 transition-all duration-500 ease-in-out"></div>
                    <p className="text-[#DE9983]/80 text-base leading-relaxed font-light font-['Crimson_Text',_serif]">{item.description}</p>
                  </div>
                </div>
              </motion.div>
            </motion.div>
